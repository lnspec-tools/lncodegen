...
class ErrorMsg: 
    ...
    def __init__(self, msg_type, channel_id, no_keyword_len, data):
        self.msg_type = msg_type
        self.channel_id = channel_id
        self.no_keyword_len = no_keyword_len
        self.data = data
    # close scope
    ...
    def encode(self) -> str:
        ...
        raw_msg += self.channel_id.encode()
        raw_msg += '{}'.format(self.no_keyword_len.encode())
    ...
    def decode(raw_msg: str):
        ...
        channel_id, raw_msg = ChannelId.decode_from_hex(raw_msg)
        no_keyword_len, raw_msg = U16Int.decode_with_hex_str(raw_msg)
        data, raw_msg = Bitfield.decode_with_len(raw_msg)
        return ErrorMsg(msg_type, channel_id, no_keyword_len, data)
# close scope
...
class WarningMsg: 
    ...
    def decode(raw_msg: str):
        ...
        no_keyword_len, raw_msg = U16Int.decode_with_hex_str(raw_msg)
        data, raw_msg = Bitfield.decode_with_len(raw_msg)
        return WarningMsg(msg_type, channel_id, no_keyword_len, data)
# close scope
